...
Airport::Airport(): AInfrastructure(AIRPORT_NAME) {
  ...
  this->_map_fill_callback["description"] = &Airport::_set_description;
...
void  Airport::_set_description(const std::string &param) { this->_description = param; }
...
void  Airport::_set_iata_code(const std::string &param) { this->_name = param; }
...
std::string Airport::get_log() {
    ...
    ss << "Description: " << this->_description << "\n";
